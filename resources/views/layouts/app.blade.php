  ...
  <div id="app">
      ...
      <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
          ...
          <ul class="navbar-nav ml-auto">
            ...
            @guest
              <li class="nav-item"><a href="/conocenos" class="nav-link">Conocenos</a></li>
            ...
            @else
              <li class="nav-item">
                <a href="{{ route('pedido.show') }}" class="nav-link">
                  Mi carrito<span class="fa-stack has-badge">
              ...
              <li class="nav-item dropdown">
                ...
                <div class="dropdown-menu">
                  <a class="dropdown-item" href="{{ route('usuarios.edit') }}">Cambiar contraseña</a>
    ...
    <nav id="sidebar-principal" role="navigation" class="sidebar d-block d-sm-none">
      ...
      <ul class="menu">
        ...
        @else
          <li>Menu</li>
          <li><a href="{{ route('usuarios.edit') }}">Cambiar contraseña</a></li>
          <li><a href="{{ route('pedido.show') }}">Carrito <i class="fa fa-shopping-cart"></i></a></li>
          <li><a href="/conocenos">Conocenos</a></li>
          <li><a href="/contacto">Contacto</a></li>
